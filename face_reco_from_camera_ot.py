...
create_table_sql = f"CREATE TABLE IF NOT EXISTS {table_name} (name TEXT UNIQUE, time TEXT)"
...
class Face_Recognizer:
    ...
    def attendance(self,name):
        ...
        try:
            insert_sql = f"INSERT OR IGNORE INTO {table_name}(name,time)VALUES(?,?)"
            cursor.execute(insert_sql,(name,current_time))
